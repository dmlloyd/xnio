 ...
 */
public interface CloseableChannel extends Channel, CloseCallbackChannel {

    /**
     * Close this channel.  When a channel is closed, its close listeners are invoked.  Invoking this method
